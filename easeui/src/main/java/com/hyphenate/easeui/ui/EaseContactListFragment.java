...
public class EaseContactListFragment extends EaseBaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        titleBar.setRightImageResource(R.drawable.ic_add);
        ...
        if (noticeOnClickListener!=null){
            lay_notice.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    noticeOnClickListener.noticeOnClick(v);
                }
            });
        }
        ...
        if (addOnClickListener != null) {
            titleBar.setRightLayoutClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    addOnClickListener.addOnClick(v);
                }
            });
        }
     ...
     */
    public void moveToBlacklist(final String username) {
